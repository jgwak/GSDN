...
INPUT_PCD = '/home/jgwak/tmp/pc_sampler/Uvalda_small.ply'
INPUT_MESH = '/cvgl/group/Gibson/gibson_v2/Uvalda/mesh_z_up.obj'
LOCFEAT_IDX = 2
MIN_CONF = 0.8
...
def main():
  ...
  pred_pcd = pc_utils.visualize_bboxes(pred[:, :6], pred[:, 6], num_points=1000)
