...
from models.modules.resnet_block import BasicBlock, Bottleneck, BasicBlockSN, BottleneckSN, BasicBlockIN, BottleneckIN
...
class Res16UNetSN18(Res16UNet18):
  NORM_TYPE = NormType.SPARSE_SWITCH_NORM
  BLOCK = BasicBlockSN
...
class Res16UNetSN101(Res16UNet101):
  NORM_TYPE = NormType.SPARSE_SWITCH_NORM
  BLOCK = BottleneckSN


class Res16UNetIN14(Res16UNet14):
  NORM_TYPE = NormType.SPARSE_INSTANCE_NORM
  BLOCK = BasicBlockIN


class Res16UNetIN18(Res16UNet18):
  NORM_TYPE = NormType.SPARSE_INSTANCE_NORM
  BLOCK = BasicBlockIN


class Res16UNetIN34(Res16UNet34):
  NORM_TYPE = NormType.SPARSE_INSTANCE_NORM
  BLOCK = BasicBlockIN


class Res16UNetIN50(Res16UNet50):
  NORM_TYPE = NormType.SPARSE_INSTANCE_NORM
  BLOCK = BottleneckIN


class Res16UNetIN101(Res16UNet101):
  NORM_TYPE = NormType.SPARSE_INSTANCE_NORM
  BLOCK = BottleneckIN
...
class STRes16UNetIN14(STRes16UNet14):
  NORM_TYPE = NormType.SPARSE_INSTANCE_NORM
  BLOCK = BasicBlockIN


class STRes16UNetIN18(STRes16UNet18):
  NORM_TYPE = NormType.SPARSE_INSTANCE_NORM
  BLOCK = BasicBlockIN


class STRes16UNetIN34(STRes16UNet34):
  NORM_TYPE = NormType.SPARSE_INSTANCE_NORM
  BLOCK = BasicBlockIN
...
class STRes16UNetIN101(STRes16UNet101):
  NORM_TYPE = NormType.SPARSE_INSTANCE_NORM
  BLOCK = BottleneckIN
